...
local function gray(x, inverted)
	if inverted == true then
		x = 100 - x
	end
	-- TODO : Tint parameter in config (tint_hue and tint_sat)
	return hsl(210, 2, x)
end

local function generate_variants(h, s, l)
	local variance = 10
	return {
		default = hsl(h, s, l),
...
if vim.o.background == "dark" then
	palette = {
		-- base1 = colors.grays["100"],
		-- base1 = gray(12),
		-- base2 = colors.grays["250"],
		-- base3 = colors.grays["350"],
		--
		-- hidden = colors.grays["300"],
		-- mid = gray(55),
		--
		-- norm1 = colors.grays["600"],
		-- norm2 = colors.grays["700"],
		-- norm3 = colors.grays["800"],
...
local hlgroups = {
	...
	TelescopeSelectionCaret = { fg = colors.primary.default },
	--}}}
	-- whichkey.nvim {{{
